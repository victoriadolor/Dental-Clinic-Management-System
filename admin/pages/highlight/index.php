                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Highlight Content</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h3 class="card-title">Highlight Content</h3>
                                </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <span class="direct-chat-timestamp text-sm">Recommended Size : 1000x600</span>
