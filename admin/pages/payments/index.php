                                ...
                                <div class="card-body">
                                    <table id="payment-table" class="table table-borderless table-hover" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $i = 1;
                                            $sql = "SELECT a.patient_name,p.payment_status,p.id,p.created_at,p.ref_id,p.amount,p.method,.p.txn_id FROM payments p INNER JOIN tblappointment a ON a.id = p.app_id ORDER BY id DESC";
