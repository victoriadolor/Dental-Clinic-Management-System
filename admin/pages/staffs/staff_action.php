...
if (isset($_POST['deletedata'])) {
    ...
    if ($query_run) {
        if ($image != NULL) {
            if (file_exists('../../../upload/staff/' . $image)) {
                unlink("../../../upload/staff/" . $image);
            }
        }
...
?>
            <div class="text-center">
                <img src="../../../upload/staff/<?= $row['image'] ?>" class="img-thumbnail img-fluid img-circle" width="120" alt="Staff Image">
            </div>
        ...
        if (mysqli_num_rows($checkemail_run) > 0) {
            ...
            if ($image != NULL) {
                ...
                if (!in_array($image_extension, $allowed_file_format)) {
                    ...
                    $filename = time() . '.' . $image_extension;
                    move_uploaded_file($_FILES['doc_image']['tmp_name'], '../../../upload/staff/' . $filename);
                }
            } else {
                ...
                imagepng($imagecreate, '../../../upload/staff/' . $path);
